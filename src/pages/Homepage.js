      ...
      <><></><div className="homepage">
         <div className="mask-group-parent">
           ...
           {trendingNow.map((item, index) => {
             return (
               <><img className="fan-img2-icon" alt="" src={item.ImageUrl[0]} />
                 <img className="fan-img2-icon" alt="" src={item.ImageUrl[1]} />
                 <img className="fan-img4-icon" alt="" src={item.ImageUrl[2]} />
                 <img className="fan-img5-1-icon" alt="" src={item.ImageUrl[3]} />
                 <img className="fan-img5-2-icon" alt="" src={item.ImageUrl[4]} />
                 <img className="fan-img6-icon" alt="" src={item.ImageUrl[5]} />
                 <img className="fan-img7-icon" alt="" src={item.ImageUrl[6]} />
                 <img className="fan-img8-icon" alt="" src={item.ImageUrl[7]} />
               </>
             );
           })}
         ...
         </div><b className="watchflix">
           <span>Watch</span>
           <span className="flix">Flix</span>
         </b><b className="watchflix1">
           <span>Watch</span>
           <span className="flix">Flix</span>
         </b><div className="homepage-inner">
